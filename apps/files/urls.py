...
from .views import FileUploadView, FilesListView, FileDeleteView, FileUpdateView, FileResultsView

urlpatterns = [
    path('files/', FilesListView.as_view(), name='files_list'),
    path('upload/', FileUploadView.as_view(), name='file_upload'),
    path('file_results/<int:pk>/', FileResultsView.as_view(), name='file_results'),
